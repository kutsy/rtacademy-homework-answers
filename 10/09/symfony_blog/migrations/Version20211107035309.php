 ...
 */
final class Version20211107035309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, category_id INT NOT NULL, cover_id INT NOT NULL, status_id INT NOT NULL, title VARCHAR(128) NOT NULL, alias VARCHAR(128) NOT NULL, description VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, publish_date DATETIME NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), INDEX IDX_5A8A6C8D12469DE2 (category_id), INDEX IDX_5A8A6C8D922726E9 (cover_id), INDEX IDX_5A8A6C8D6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE post_cover (id INT AUTO_INCREMENT NOT NULL, filename VARCHAR(128) NOT NULL, alt VARCHAR(128) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
